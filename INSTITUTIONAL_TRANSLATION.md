...
| Vocabulaire Anthropie | Traduction administrative recevable |
|---|---|
...
| Anthropie | Traduction recevable |
|---|---|
...
| Anthropie | Formulation institutionnelle |
|---|---|
...
- ❌ "civilisationnel" → préférer *« multi-générationnel »* ou *« long terme »*
- ❌ "édifice" (sans contexte) → préférer *« cadre méthodologique »* ou *« corpus pédagogique »*
- ❌ "mycéliale" / "mycélien·ne" → préférer *« groupe de pratique réflexive »*
- ❌ "Hospice" (hors contexte fin de vie) → préférer *« lieu communautaire d'accompagnement »*
- ❌ "doctrine" → préférer *« cadre méthodologique »*, *« principes »*, *« approche »*
- ❌ "porteur" / "porteuse" → préférer *« praticien·ne »*, *« responsable de projet »*
- ❌ "rite de passage" (hors anthropologie) → préférer *« transition encadrée »*
- ❌ "anti-anthropomorphisme" → préférer *« approche relationnelle non-projective avec le vivant non-humain »*
...
5. **Limites éthiques** : si l'institution agit dans l'intérêt **réel** d'un mineur ou d'une personne vulnérable (signalement ASE, hospitalisation contrainte justifiée), **respecter la décision**. L'édifice n'est pas un recours contre la protection de l'enfance ou la psychiatrie d'urgence (cf. [`SAFETY.md` §3](garde-fous/)).

---

## 8. Limites de cette traduction

- **Pas une procédure légale.** Adapter à votre juridiction, faire relire par juriste pour cas sensibles. Cf. [`LEGAL_BOUNDARIES.md` §3](cadre/).
- **Pas un manuel d'opposition systématique.** L'objectif est d'être recevable, pas de gagner contre l'institution. Si l'opposition est totale, il vaut peut-être mieux changer d'institution.
- **Pas un substitut à un avocat / médiateur professionnel** dans les cas conflictuels graves (placement enfant, hospitalisation contrainte, conflit avec services sociaux).
- **Adaptable.** Cette table est un point de départ ; toute formulation utilisée dans un contexte concret peut être améliorée par retour d'expérience. Pull Request bienvenue.
...
- **Contexte** (sans nommer l'institution si confidentialité requise) : type d'instance, juridiction, taille.
- **Demande initiale en vocabulaire Anthropie**.
- **Traduction utilisée** dans le mail / formulaire / rendez-vous.
- **Réception** : accueil neutre, accord, refus argumenté, refus net, escalade.
- **Apprentissage** : ce qui a aidé, ce qui a buté.
