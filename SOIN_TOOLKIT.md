...
- **Couche 10 (LE CONSEIL DES MORTS)** : si la personne décède, la Feuille et la rotation deviennent **traces** que les proches peuvent intégrer dans leur [`BOITE_DES_ABSENTS.md`](boite-des-absents/) (pochette 6 *Lieux*, pochette 8 *Dettes et gratitudes*).
- **Couche 12 (LE SEUIL DE LA BRISURE)** : ces dispositifs sont des **anti-pathologisations** opérationnelles — ils refusent que la personne soit réduite à son diagnostic.
